...
#SBATCH -t 02:30:00
#SBATCH --output=/cephyr/users/hilmaha/Vera/BIO511/WGS_project/logs/flye_polished_%j.out
#SBATCH --error=/cephyr/users/hilmaha/Vera/BIO511/WGS_project/logs/flye_polished_%j.err
...
OUTPUT_DIR="${RESULTS_PATH}/assembly_q20/flye_polished_q20"
...
singularity exec ${SINGULARITY_PATH} flye --nano-raw /data/CCUG-55970_q20.fastq.gz \
     --out-dir /results/assembly_q20/flye_polished_q20 \
     --threads 12 \
     --iterations 5 \
